...
cols_add = [f for f in df_all.columns if f.startswith("cortex") or f == "sub_idx" or f == "pkg_dk_class" 
                or f == "pkg_dk_normed" or f == "pkg_dt" or f == "cortex_hour"]
...
for sub_idx, sub in enumerate(subs):
    ...
    for idx in idx_30min:
        feature_arr.append(
            df_sub.loc[idx - 14:idx, :][cols_add].values
        )

f_arr = np.array(feature_arr)
np.save(r"E:\Downloads\all_merged_normed_rmap.npy", f_arr, )
